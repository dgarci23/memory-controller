	sdram_controller u0 (
		...
		.sdram_pll_ref_clk_clk     (<connected-to-sdram_pll_ref_clk_clk>),     //   sdram_pll_ref_clk.clk
		.sdram_pll_sdram_clk_clk   (<connected-to-sdram_pll_sdram_clk_clk>),   // sdram_pll_sdram_clk.clk
		.sdram_pll_ref_reset_reset (<connected-to-sdram_pll_ref_reset_reset>)  // sdram_pll_ref_reset.reset
	);
